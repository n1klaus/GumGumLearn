...
export default function Home() {
  ...
  const items = []
      ...
      const formatResult = (item) => {
        return (
          <>
            ...
            <span style={{ display: 'block', textAlign: 'left' }}>match: {item.name}</span>
          </>
        )
      }
    ...
    // useEffect(() => {
    //     // setText();
    //     console.log(`Searching text: ${search_text}`);
    //     // return <SearchHelper word={search_text} />
    // }, [search_text])
	return (
    <>
